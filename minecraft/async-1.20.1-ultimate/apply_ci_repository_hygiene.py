...
# Bawnorton-hosted Mixinsquared dependencies are intentionally disabled in this
# release. Fail closed if one is ever re-enabled before removing its repository.
for p in files:
