...
- Deferred worker-thread `LivingEntity.pushEntities()` calls and replayed the original vanilla method after the entity-worker barrier.
...
- Corrected misleading GPU benchmark/status text.
